...
function NoticeBookingUnavailable(props: Props) {
  ...
  return (
    <>
      {unAvailableBooking && (
        <div className="text-[14px] leading-[18px] lg:text-[16px] lg:leading-[24px] rounded-full border border-primary-500 bg-primary-50 text-primary-700 mb-5 flex flex-col gap-3 px-4 py-4 lg:px-4 lg:py-2 bg-red-100">
