...
function NoticeBookingUnavailable(props: Props) {
  ...
  return (
    <>
      {unAvailableBooking && (
        <div className="text-[14px] leading-[18px] lg:text-[16px] lg:leading-[24px] rounded-full border border-primary-500 text-primary-700 mb-5 flex flex-col gap-3 px-10 py-4 lg:px-5 lg:py-2 bg-primary-100">
