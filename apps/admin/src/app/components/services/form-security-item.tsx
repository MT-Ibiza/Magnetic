...
export function FormSecurityItem(props: Props) {
  ...
  const onSubmit = async (data: ItemBase) => {
    ...
    if (securityAttributes) {
      formData.append(
        'securityAttributes',
        JSON.stringify({
          hours: Number(securityAttributes.hours),
        })
      );
    }
            ...
            <div className="flex flex-col lg:flex-row gap-6">
              <div className="w-full">
                ...
                <Input
                  ...
                  min={1}
                  placeholder=""
                  {...register('securityAttributes.hours', {
                    required: 'Hours is required',
                  })}
                />
                {errors.securityAttributes?.hours && (
                  <p className="text-[12px] text-red-500 pt-2">
                    {errors.securityAttributes?.hours.message}
                  </p>
                )}
              </div>
              <div className="w-full">
          ...
          <div className="adicional-info flex-1 space-y-6">
            ...
            <div className="variants bg-base-100 border rounded-lg p-6">
              <div className="flex justify-between items-center pb-2">
                <Text className="font-semibold text-lg">Security Variants</Text>
                <Text
...
export default FormSecurityItem;
