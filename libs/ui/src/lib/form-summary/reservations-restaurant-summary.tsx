...
function ReservationRestaurantSummary(props: Props) {
  ...
  return (
    <div className="p-10">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          <Text className="font-medium">Preferred Time</Text>
      ...
      <div className="mt-6">
        <Text className="font-medium">Beach Reservations (if applicable)</Text>
        <Text className="text-gray-500">{formData.beachReservations || 'N/A'} </Text>
      </div>
    </div>
  );
}

export default ReservationRestaurantSummary;
