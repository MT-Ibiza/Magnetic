import {
  WeeklyButlerServiceFormData,
} from '@magnetic/interfaces';
import { Text } from '@magnetic/ui';
import { formatDate, formatTime } from '@magnetic/utils';

interface Props {
  formData: WeeklyButlerServiceFormData;
}
function WeeklyChefsButlerSummary(props: Props) {
  ...
  return (
    <div className="p-10">
      ...
      <div className="mt-6">
        <Text className="font-medium">Comments & Preferences</Text>
        <Text className="text-gray-500">{formData.commentsPreference}</Text>
      </div>
    </div>
  );
}

export default WeeklyChefsButlerSummary;
