...
export function ReservationsBookingForm({
  onSubmit,
  formData,
  onCancel,
  user,
    ...
    <div>
      <Modal.Header onClose={onCancel}>
        <div className="flex justify-between">
          <h2 className="text-2xl font-bold">Reservation Booking</h2>
        </div>
      </Modal.Header>
      <form onSubmit={handleSubmit(handleFormSubmit)}>
        <Modal.Body>
          <div className="p-10 flex flex-col gap-6">
            ...
            <div className="">
              <Text className="mb-2">Beach Reservations</Text>
              <TextArea
                className="w-full"
...
export default ReservationsBookingForm;
