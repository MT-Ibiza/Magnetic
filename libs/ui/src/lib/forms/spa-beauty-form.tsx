import { FormSubmitParams, SpaBeautyFormData } from '@magnetic/interfaces';
...
export function SpaBeautyBookingForm({ onSubmit }: Props) {
  ...
  return (
    <div className="spa-beauty-form max-w-5xl mx-auto p-6 bg-base-100 shadow-md rounded-md">
      <h2 className="text-2xl font-bold text-center mb-6">
        SPA & Beauty Booking (Platinum)
      </h2>
